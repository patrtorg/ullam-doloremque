# @patrtorg/ullam-doloremque

[![NPM](https://img.shields.io/npm/v/@patrtorg/ullam-doloremque.svg?style=flat-square)](https://www.npmjs.com/package/@patrtorg/ullam-doloremque)
[![GitHub Workflow Status (master)](https://img.shields.io/github/actions/workflow/status/jhildenbiddle/@patrtorg/ullam-doloremque/test.yml?branch=master&label=checks&style=flat-square)](https://github.com/patrtorg/ullam-doloremque/actions?query=branch%3Amaster+)
[![Codacy code quality](https://img.shields.io/codacy/grade/ec8f2d2595804ab38ad138b762a640e6/master?style=flat-square)](https://app.codacy.com/gh/jhildenbiddle/@patrtorg/ullam-doloremque/dashboard?branch=master)
[![Codacy branch coverage](https://img.shields.io/codacy/coverage/ec8f2d2595804ab38ad138b762a640e6/master?style=flat-square)](https://app.codacy.com/gh/jhildenbiddle/@patrtorg/ullam-doloremque/dashboard?branch=master)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://github.com/patrtorg/ullam-doloremque/blob/master/LICENSE)
...
```shell
npm install @patrtorg/ullam-doloremque --save
```

```javascript
// file.js
import getCssData from '@patrtorg/ullam-doloremque';
...
```bash
git clone https://github.com/patrtorg/ullam-doloremque.git
```
...
```html
<!-- ES5 (latest v2.x.x) -->
<script src="https://cdn.jsdelivr.net/npm/@patrtorg/ullam-doloremque@2"></script>
<script>
  getCssData({
    onComplete: function(cssText, cssArray, nodeArray) {
      // Do stuff...
...
<script type="module">
  import getCssData from 'https://cdn.jsdelivr.net/npm/@patrtorg/ullam-doloremque@2/dist/@patrtorg/ullam-doloremque.esm.min.js';
...
- Create a 💬 [GitHub issue](https://github.com/patrtorg/ullam-doloremque/issues) for bug reports, feature requests, or questions
- Add a ⭐️ [star on GitHub](https://github.com/patrtorg/ullam-doloremque) and 🐦 [tweet](https://twitter.com/intent/tweet?url=https%3A%2F%2Fgithub.com%2Fjhildenbiddle%2F@patrtorg/ullam-doloremque&hashtags=css,developers,frontend,javascript) to promote the project
- Become a 💖 [sponsor](https://github.com/sponsors/jhildenbiddle) to support the project and future efforts

## License

This project is licensed under the MIT License. See the [LICENSE](https://github.com/patrtorg/ullam-doloremque/blob/master/LICENSE) for details.
